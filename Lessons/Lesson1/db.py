    ...
    def init_db(self):
        with self.con:
            ...
            for i, (u, t) in enumerate(
                [
                    ("sergei", n.replace(year=2018,month=8, day=3)),
                    ("valentin87", n.replace(year=2018,month=8, day=4)),
                    ("igor99", n.replace(year=2018,month=7, day=1)),
                    ("anton4", n.replace(year=2018,month=1, day=10)),
                    ("vera2000", n.replace(year=2018,month=4, day=14)),
                    ("sunnyside", n.replace(year=2018,month=2, day=24)),
                    ("sarah.connor", n.replace(year=2018,month=1, day=2)),
                    ("andrey3", n.replace(year=2018,month=4, day=21)),
                    ("alexei22", n.replace(year=2018,month=2, day=17)),
